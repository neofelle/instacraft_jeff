...
function showOrUpdateDialogInUI(itemRes, updateHtml) {
  ...
  if (dialogType == 3) {
    ...
    opponentLogin = getUserLoginById1(opponentId);
    dialogName    = 'Chat with ' + opponentLogin;
  }
...
// create new dialog
function createNewDialog1() {

  var usersIds   = ['20986426'];
  var usersNames = ['Support'];
  ...
  if (usersIds.length > 1) {
    ...
    dialogOccupants = usersIds;
    dialogType = 2;
    dialogName=dialogName = currentUser.login + ', ' + usersNames.join(', ');
  }
