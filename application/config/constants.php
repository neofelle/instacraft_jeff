...
define('JOB_REJECTED',"3");
define('JOB_COMPLETED',"4");
define('JOB_CANCELLED',"5");
define('JOB_ADMIN_CREATE',"10");
...
define('RECORDS_PERPAGE', 10); // no errors
define('RECORDS_PERPAGE_5', 5); // no errors


define('AUTH_LOGIN_ID','4H3kq6MUj');
define('AUTH_TRANSACTION_KEY', '6v5XD8P7Cx324syT');

/*auth constants*/
$currentUTCTime = round(microtime(true));
define('currentUTCTime',$currentUTCTime);

$timestamp = $currentUTCTime + 60*1000;
//$nextOneHourTime = strtotime(date('H:i:s', $timestamp));
define('nextOneHourTime',$timestamp);

/*Secret key*/
define('secretKey',"C@mMu^e324234NT34dfdf@@!!uSer7892dsjk3455345hfjbcv");
