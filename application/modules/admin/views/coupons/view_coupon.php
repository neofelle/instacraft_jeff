...
<div class="page-content-wrapper">
    <div class="page-content" style="min-height:895px"> 
        ...
        <?php } ?>
        <!------------------content start ------------------------------>
        <?php //print_r($couponinfo['valid_from']);die; ?>
        <!-- BEGIN FORM-->
        <form class="form-horizontal" id="addCoupon" name="addCoupon" action="" style="min-height:495px;" role="form" method="post">                
            <h3 class="page-title ">Coupon Detail</h3>   
                <input type="hidden" name="cid" value="<?php echo $couponinfo['id']; ?>" />
                <div class="row padLeftZero">
                     
                    <div class="col-md-6 ">
                        <div class="form-group">
                            <label for="link">Coupon Name </label>
                            <input type="text" id="cname" name="cname" class="form-control" placeholder="Coupon name " minlength="5" maxlength="30" style="width:90%;display: inline-block;" value="<?php echo $couponinfo['name'] ? $couponinfo['name'] : '';  ?> " >
                            <span id="cname-error" class="help-block hide"></span>
                        </div>
                        <div class="form-group">
                            <label for="link">Minimum Order Price</label>
                            <input type="text" id="cminorder_price" name="cminorder_price" minlength="1" maxlength="8" class="form-control" placeholder="Minimum order price" style="width:90%;display: inline-block;" value="<?php echo $couponinfo['min_order_price'] ? $couponinfo['min_order_price']: ''; ?>" onkeypress="return isNumberKey(event)">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 padLeftZero" >
                                ...
                                <input type="text" id="code" name="code" class="form-control" minlength="5" maxlength="20" placeholder="Coupon code " style="width: 90%;display: inline-block;" value="<?php echo $couponinfo['code'] ? $couponinfo['code']: ''; ?>" >
                            </div>  
                            <div class="col-md-6 padLeftZero" >
                                <label for="link" style="width:90%;">validity (No. of month)</label>
                                <input type="text" id="validity" name="validity" class="form-control" placeholder="e.g: 3" style="width: 85%;display: inline-block;" value="<?php echo $couponinfo['validity'] ? $couponinfo['validity']: ''; ?>" onkeypress="return isNumberKey(event)">
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="link">Coupon price</label>
                            <input type="text" id="points" name="points" class="form-control" placeholder="Coupon price" style="width:90%;display: inline-block;" value="<?php echo $couponinfo['points'] ? $couponinfo['points']: ''; ?>" onkeypress="return isNumberKey(event)" >
                            <span id="price-error" class="help-block hide"></span>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6 padLeftZero" >
                                <label for="link" style="width:90%;">Discount Amount/Percentage</label>
                                <input type="text" id="discount" name="discount" minlength="1" maxlength="8" class="form-control" placeholder="Discount amount/percentage" style="width: 90%;" value="<?php echo $couponinfo['discount'] ? $couponinfo['discount']: ''; ?>" onkeypress="return isNumberKey(event)">
                            </div>  
                            <div class="col-md-6 padLeftZero" >
                                ...
                                <select id="distype" name="distype" placeholder="" class="form-control" style="width:85%;" >
                                    <option value="1" <?php echo $couponinfo['discount_type'] == '1' ? 'selected' : ''; ?> >Amount </option>
                                    <option value="2" <?php echo $couponinfo['discount_type'] == '2' ? 'selected' : ''; ?> >Percentage</option>
                                </select>
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="link">Applicable product category</label>
                            <?php $catid = $couponinfo['category_id']; ?>
                            <select id="categoryid" name="categoryid" placeholder="" class="form-control" style="width:90%;display: inline-block;" >
                                ...
                                <?php if(count($categories) > 0): ?>
                                    <?php foreach($categories as $category): ?>
                                        <option value="<?php echo $category['catid']; ?>" <?php echo $couponinfo['category_id'] == $category['catid'] ? "selected" : ""; ?> ><?php echo $category['catname']; ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        ...
                        <div class="form-group">
                           <button type="submit" class="btn green" name="adddCouponBtn"><i class="fa fa-check"></i> Update</button>
