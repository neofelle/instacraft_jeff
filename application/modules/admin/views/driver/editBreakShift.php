        ...
        <div class="col-lg-6">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" method="POST" action="<?php echo base_url(); ?>update-break-time">
                            ...
                            <input type="hidden" class="form-control timepicker" name="date" id="" value="<?php echo $breakTime['date']; ?>" >

                            <div class="form-group">
                                <label for="exampleInputEmail1">From time: </label>
                                <input type="text" class="form-control timepicker" name="from_time" id="" value="<?php echo $breakTime['start_time']; ?>" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">To time: </label>
                                <input type="text" class="form-control timepicker2" name="to_time" id="exampleInputPassword1" value="<?php echo $breakTime['end_time']; ?>" >
                            </div>
                            <div class="form-group">
