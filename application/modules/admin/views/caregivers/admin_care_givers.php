...
<!--        <h3 class="page-title page_mrg">Manage Users</h3>-->
        ...
        <div class="row-fluid top-act">   
            ...
            <div class="form-group pull-right">
                <a class="btn red reset p-xl-pad" href="add-care-giver" id="add_care_giver"><i class="fa fa-plus" style="color:white;"></i> Add Doctor</a>
            </div>
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content table-hover" >
                        <thead class="flip-content">
                            <tr>
                                ...
                                <th class="numeric"> Identity No. </th>
                        ...
                        <?php
                         if (count($result) > 0) {
                            ...
                            foreach ($result as $key => $list) {
                                ...
                                if($list['country'] != ''){
                                    $address != '' ? $address .=', ' : $address .='';
                                    $address .= ucfirst($list['country']);
                                }
                                if($list['zip_code'] != ''){
                                    $address != '' ? $address .=' - ' : $address .='';
                                    $address .= ucfirst($list['zip_code']);
                                }
                        ?>
                                    <tr>
                                        <td> <?php echo $i + 1; ?> </td>
                                        <td class="numeric editable"><b><?php echo ucfirst($list['name'])." ".ucfirst($list['doctor_lname'])."</b>"; ?></td>
                                        <td class="numeric editable"><?php echo $list['email']; ?> </td>
                                        <td class="numeric editable"><?php echo $list['telephone_number'];   ?></td>
                                        <td class="numeric editable"><?php echo $address; ?> </td>
                                        <td class="numeric editable"><?php echo $list['designee_name']; ?></td>
                                        <td class="numeric editable"><b><?php echo $list['identification_number']; ?></b></td>
                                        <td class="action">
                                            <span class="no_wrap">
                                                <span class="no_wrap" ><a title="View/Edit" id ="viewItem" href="care-giver-details/<?php echo $list['id']; ?>" class="btn btn-default btn-xs"> <i class="fa fa-pencil-square-o" style="color:#036891;"></i> </a></span>
                                                <span class="no_wrap" ><button title="Delete" id ="userDel" href="delete-care-giver/<?php echo $list['id']; ?>" class="btn btn-default btn-xs"> <i class="fa fa-trash-o" style="color:red;"></i> </button></span>
                                            </span>
                                        </td>
                                    </tr>                                
                                <?php
