                    ...
                    <div class="panel with-nav-tabs panel-danger">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="#manageWarehouses" data-toggle="tab">Manage Warehouse</a></li>
...
<?php } ?>
                                    ...
                                    <div class="row-fluid top-act" >  
                                        ...
                                        <form action='' id="searchData" method="post" >  
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li><a href="<?php echo base_url(); ?>manage-warehouses">Manage Ware Houses</a></li>
                                                <!-- <li ><a href="#">Add-Users</a></li> -->
                                                <li class="active"><span>View Ware Houses</span></li>
                                            </ol>
                                    ...
                                    <div class="row row_mrg" id="myData">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" id="addWarehouse" name="addWarehouse" action=""  role="form" enctype='multipart/form-data' method="post">                         
                                                <div class="col-md-7 ">
                                                ...
                                                <div class="col-md-5 ">
                                                    <div class="form-group">
                                                        <label for="warename" >Ware House Name </label>
                                                        <input type="text" id="warename" name="warename" class="form-control" placeholder="Warehouse Name" style="width:90%;display: inline-block;" maxlength="50" value="<?php echo $whinfo['warehouse_name'] ? $whinfo['warehouse_name'] : ''; ?>" >
                                                        <span><i id="fmailychk" class=""></i></span>
                                                        <span id="warename-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div id="whaddress" class="form-control notEditadble" placeholder="Email" style="width:90%;    height: 58px;display: inline-block;     word-wrap: break-word;"><?php echo $whinfo['warehouse_address'] ? $whinfo['warehouse_address'] : ''; ?></div>
                                                        <input type="hidden" id="address" name="address" class="form-control" style="width:90%;display: inline-block;" value="<?php echo $whinfo['warehouse_address'] ? $whinfo['warehouse_address'] : ''; ?>" >
                                                        <input type="hidden" id="latlng" name="latlng" class="form-control" style="width:90%;display: inline-block;" value="<?php echo ($whinfo['warehouse_lat'] && $whinfo['warehouse_lang']) ? $whinfo['warehouse_lat'] . ',' . $whinfo['warehouse_lang'] : ''; ?>" >
                                                        <input type="hidden" id="whid" name="whid" class="form-control" style="width:90%;display: inline-block;" value="<?php echo $whinfo['warehouse_id'] ? $whinfo['warehouse_id'] : ''; ?>" >
                                                        <span id="address-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group">
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/view-warehouse.js"  type="text/javascript" ></script>