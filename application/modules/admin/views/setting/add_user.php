                            ...
                            <div class="tab-content ">
                                <div class="tab-pane fade in active o" id="manageUsers">
                                    ...
                                    <div class="row row_mrg" id="myData">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" id="addUser" name="addUser" action=""  role="form" enctype='multipart/form-data' method="post">                         

                                                <div class="col-md-4 ">
                                                    <h3>&nbsp;</h3>
                                                    <div class="form-group">
                                                        <input type="text" id="fname" name="fname" class="form-control" placeholder="First Name" style="width:90%;display: inline-block;" maxlength="25" value="" >
                                                        <span id="fname-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" id="lname" name="lname" class="form-control" placeholder="Last Name" style="width:90%;display: inline-block;" maxlength="25" value="" >
                                                        <span id="lname-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" id="email" name="email" class="form-control" placeholder="Email" style="width:90%;display: inline-block;" maxlength="128" value="" >
                                                        <span id="email-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" id="contact" name="contact" class="form-control" placeholder="contact" style="width:90%;display: inline-block;" maxlength="12" onkeypress="return isNumberKey(event)" value="" >
                                                    ...
                                                    <div class="form-group">
                                                        <fieldset class="" style="    padding: 0px 5px 5px 5px;border: 1px solid #c6b5b5;">
                                                            ...
                                                            <?php foreach ($modules as $module) {
                                                                ?>
                                                                <label class="width150" for="catid_<?php echo $module[id]; ?>"><input class="groupchk" type="checkbox" data-info="category_<?php echo $module[id]; ?>" id="catid_<?php echo $module[id]; ?>" name="modules[]" value="<?php echo $module[id]; ?>" > <?php echo $module['module_name']; ?> </label>
                                                                <?php
                                                            }
                                                            ?>                                                                   
                                                            <input type="hidden" id="selectedModules" name="selectedModules" value="">
                                                            <span id="modules-error" class="help-block hide"></span>

                                                        </fieldset>
                                                    </div>
                                                    <div class="form-group">
                                                        <button type="submit" class="btn green" name="adddMessageBtn"><i class="fa fa-check"></i> Create User</button>
                                                        <a type="button" href="manage-users" class="btn default "><i class="fa fa-remove"></i> Cancel</a> 
                                                    </div>
                                                </div>
                                                <!------------------content end---------------------------------->            
                                            </form>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/add-admin-user.js"  type="text/javascript" ></script>
<script>
