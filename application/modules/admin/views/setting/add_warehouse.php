                                    ...
                                    <div class="row-fluid top-act" >  
                                        ...
                                        <form action='' id="searchData" method="post" >  
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="active"><span>Add Ware Houses</span></li>
                                            </ol>
                                            ...
                                            <form class="form-horizontal" id="addWarehouse" name="addWarehouse" action=""  role="form" enctype='multipart/form-data' method="post">                         
                                                ...
                                                <div class="col-md-5 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="warename" name="warename" class="form-control" placeholder="Warehouse Name" style="width:90%;display: inline-block;" maxlength="50" value="" >
                                                        <span><i id="fmailychk" class=""></i></span>
                                                        <span id="warename-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div id="whaddress" class="form-control notEditadble" placeholder="Email" style="width:90%;    height: 58px;display: inline-block;     word-wrap: break-word;"><i style="font-weight:200 !important;"> Not set yet </i></div>
                                                        <input type="hidden" id="address" name="address" class="form-control" style="width:90%;display: inline-block;" value="" >
                                                        <input type="hidden" id="latlng" name="latlng" class="form-control" style="width:90%;display: inline-block;" value="" >
                                                        <span id="address-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <button type="submit" class="btn green" name="newWareHouse"><i class="fa fa-check"></i> Open new warehouse</button>
                                                        <a type="button" href="manage-warehouses" class="btn default "><i class="fa fa-remove"></i> Cancel</a> 
                                                    </div>
                                                </div>
                                                <!------------------content end---------------------------------->            
                                            </form>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/add-warehouse.js"  type="text/javascript" ></script>
<script>
