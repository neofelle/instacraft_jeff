                            ...
                            <div class="tab-content ">
                                <div class="tab-pane fade in active o" id="manageUsers">
                                    ...
                                    <div class="row-fluid top-act" >  
                                        ...
                                        <form action='' id="searchData" method="post" >  
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li><a href="<?php echo base_url(); ?>manage-products">Manage Products Family</a></li>
                                                <li class="active"><span>View Product Family</span></li>
                                            </ol>
                                    ...
                                    <div class="row row_mrg" id="myData">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" id="addProductFamily" name="addProductFamily" action=""  role="form" enctype='multipart/form-data' method="post">
                                                <div class="col-md-4 ">
                                                    <h3>&nbsp;</h3>
                                                    <div class="form-group padLeftZero">
                                                        <label for="familyname">Product Family Name  </label>
                                                        <input type="text" id="familyname" name="familyname" class="form-control" placeholder="Product Family Name " style="width:75%;display: inline-block;" value="<?php echo $productinfo['family_name'] ? $productinfo['family_name'] : ''; ?>" >
                                                        <span><i id="fmailychk" class=""></i><span id="nametesting" style="position:absolute;padding:7px;"></span></span>
                                                        <span id="familyname-error" class="help-block hide"></span>
                                                    </div>
                                                    <div class="form-group padLeftZero">
                                                        <input type="hidden" id="family_id" name="family_id" value="<?php echo $productinfo['family_id'] ? $productinfo['family_id'] : ''; ?>" />
                                                        <button type="submit" class="btn green" name="addCategoryBtn"><i class="fa fa-check"></i> Update </button>
                                                        <a type="button" href="<?php echo base_url() ?>/manage-products" class="btn default "><i class="fa fa-remove"></i> Cancel</a> 
                                                    </div>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/view-product-family.js"  type="text/javascript" ></script>
<script>
