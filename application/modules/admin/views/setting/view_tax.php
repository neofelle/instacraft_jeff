                                    ...
                                    <div class="row-fluid top-act" >  
                                        ...
                                        <form action='' id="searchData" method="post" >  
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li><a href="<?php echo base_url(); ?>manage-products">Manage Taxes</a></li>
                                                <li class="active"><span>View Tax Details</span></li>
                                            </ol>
                                                ...
                                                <div class="col-md-4 ">
                                                    <h3>&nbsp;</h3>
                                                     ...
                                                     <div class="form-group padLeftZero">
                                                                ...
                                                                <input type="text" id="taxname" name="tax_name" class="form-control" placeholder="Tax Name " style="width:90%;display: inline-block;" value="<?php echo $taxinfo['tax_name'] ? $taxinfo['tax_name'] : ''; ?>" >
                                                            ...
                                                            <div class="form-group padLeftZero">
                                                                ...
                                                                <select name="tax_type" class="form-control">
                                                                    ...
                                                                    <option value="percent" <?php echo ($taxinfo['tax_type']=='percent') ? 'selected' : ''; ?>>Percent</option>
                                                                    <option value="amount" <?php echo ($taxinfo['tax_type']=='amount') ? 'selected' : ''; ?>>Amount</option>                                                                       
                                                                </select>
                                                             ...
                                                             <div class="form-group padLeftZero">
                                                                ...
                                                                <input type="text" id="amt_value" name="amt_value" class="form-control" placeholder="Amount value" style="width:90%;display: inline-block;" value="<?php echo $taxinfo['amt_value'] ? $taxinfo['amt_value'] : ''; ?>" >
                                                                <span><i id="fmailychk" class=""></i></span>
                                                                <span id="amtvalue-error" class="help-block hide"></span>
                                                            </div>
                                                    
                                                    <div class="form-group padLeftZero">
                                                        <input type="hidden" id="tax_id" name="tax_id" value="<?php echo $taxinfo['id'] ? $taxinfo['id'] : ''; ?>" />
                                                        <button type="submit" class="btn green" name="addTaxBtn"><i class="fa fa-check"></i> Update </button>
                                                        <a type="button" href="<?php echo base_url() ?>/taxes" class="btn default "><i class="fa fa-remove"></i> Cancel</a> 
                                                    </div>
