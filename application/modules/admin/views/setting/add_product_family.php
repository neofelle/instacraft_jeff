                                        ...
                                        <div class="row-fluid top-act" >  
                                            ...
                                            <form action='' id="searchData" method="post" >  
                                                <ol class="breadcrumb breadcrumb-arrow">
                                                    ...
                                                    <li class="active"><span>Add Product Family</span></li>
                                                </ol>
                                            ...
                                            <form class="form-horizontal" id="addProductFamily" name="addProductFamily" action=""  role="form" enctype='multipart/form-data' method="post">
                                                        <div class="col-md-4 ">
                                                            ...
                                                            <div class="form-group padLeftZero">
                                                                ...
                                                                <input type="text" id="familyname" name="familyname" class="form-control" placeholder="Product Family Name " style="width:90%;display: inline-block;" value="" >
                                                            ...
                                                            <div class="form-group padLeftZero">
                                                                ...
                                                                <a type="button" href="manage-products" class="btn default "><i class="fa fa-remove"></i> Cancel</a> 
                                                            </div>
