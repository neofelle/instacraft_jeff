...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
      center: {lat: 55.86336763758299, lng: -4.222869873046875},  // -21.772488, 131.564276
      zoom: 4
    });
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        */
        areaiterator = [place.geometry.location.lat(),place.geometry.location.lng()];
        
        //setChoosedLatLong(place.geometry.location.lat(),place.geometry.location.lng());
        //updateUsersCountOnPage();
    });
