...
//-- Created By N.K.
    ...
    $("#updateRestrictedArea").submit(function(event){ 
        ...
        var allowedid     = $("#allowedid").val();
        var restrictedid  = $("#restrictedid").val();
        var resDelid      = $("#resDelid").val();
        
        //--- User Id Validation
        if(allowedid != '' &&   restrictedid != '' && resDelid != ''){
            washFeedError('user_id-error');
            error['allowed_chk'] = false;
        }
        else{            
            setFeedError('user_id-error','Something went wrong unfortunately, Please try later ');
            error['allowed_chk'] = true;
        }
        ...
        if(error['allowed_chk'] == false && error['resname'] == false ){
            return true;
        }else{
            return false;
        }
