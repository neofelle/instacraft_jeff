...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/flashphoner-api-0.5.25/dependencies/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="http://localhost/flashphoner-api-0.5.25/dependencies/bootstrap/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="http://localhost/flashphoner-api-0.5.25/video-chat.css">
    <title>Two Way Video Chat</title>
    <script type="text/javascript" src="http://localhost/flashphoner-api-0.5.25/flashphoner.js"></script>
    <script type="text/javascript" src="http://localhost/flashphoner-api-0.5.25/dependencies/jquery/jquery-1.12.0.js"></script>
    <script type="text/javascript" src="http://localhost/flashphoner-api-0.5.25/dependencies/js/utils.js"></script>

    <script type="text/javascript" src="http://localhost/flashphoner-api-0.5.25/conference.js"></script>
    <!-- Bootstrap JS -->
    <script src="http://localhost/flashphoner-api-0.5.25/dependencies/bootstrap/js/bootstrap.js"></script>
